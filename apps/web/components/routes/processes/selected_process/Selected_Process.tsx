...
type Processes_Overview_Props = {
    children: ReactNode
    className?: string
}

export default function Processes_Overview({ children, className = "" }: Processes_Overview_Props) {
    const { dictionary } = useLanguage()
    const copy = dictionary.processes
